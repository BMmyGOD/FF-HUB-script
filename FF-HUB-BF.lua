...
local win = Flux:Window("FF HUB", "FF HUB X Blox Fruit",_G.Color, Enum.KeyCode.RightControl)
local tab = win:Tab("AutoFarm️","http://www.roblox.com/asset/?id=4805639000")
local Stats = win:Tab("Stats️","http://www.roblox.com/asset/?id=4805639000")
local e = win:Tab("Setting AutoFarm️","http://www.roblox.com/asset/?id=4805639000")
...
if NewWorld then
    ...
    Teleport:Button("Under Water City","", function()
    ...
    Teleport:Button("Blackleg teacher","", function()
...
-----------------------------------------------------------------------------------------------------------------------------------------------
local k = win:Tab("Other","http://www.roblox.com/asset/?id=4805639000")
k:Line()
...
k:Line()
k:Label("--Credit--", true)
k:Button("Made By RUOKitsHUMAN#6422","FF HUB", function()
end)
    k:Button("https://discord.gg/qCFWB9pErn","join discord for report bug and request more function", function()
        end)
